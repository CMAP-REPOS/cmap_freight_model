# Group the stops into tours and sequences the stops
ft_sim_stop_sequence <- function(shipments){
  ...
  ### Heither, 05-09-2016: read in zonal coordinates (read in via ft_sim_process_inputs.csv)
  ...
  ### Heither, 05-09-2016: read in zonal skim times (use Peak times) (read in via ft_sim_process_inputs.csv)
