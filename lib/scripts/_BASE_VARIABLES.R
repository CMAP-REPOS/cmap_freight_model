...
BASE_TAZ_DOMESTIC <- 1L:273L #range of Mesozones that covers the USA
BASE_TAZ_INTERNATIONAL <- 274L:1000L #range of Mesozones covering foreign countries

#Define application time periods, run years, and other temporal inputs
BASE_SCENARIO_BASE_NAME <- "base" #base year scenario name
BASE_SCENARIO_BASE_YEAR <- 2010 #base year scenario year
BASE_SCENARIO_YEARS <- c(2010, 2015, 2020, 2025, 2030, 2035, 2040) 
